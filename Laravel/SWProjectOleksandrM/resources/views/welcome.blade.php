...
<body class="antialiased">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow">
        <div class="container-fluid container">
            ...
            <!-- Dropdown Search Bar Icon Text -->
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="grey" class="bi bi-search"
                viewBox="0 0 16 16">
                <path
            ...
            <!-- Basket Icon Link -->
            <a href="/checkout">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="grey" class="bi bi-basket ms-3"
                    viewBox="0 0 16 16">
                    <path
